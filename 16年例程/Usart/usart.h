...
extern void uart0_rx_isr(void);     //接收中断
extern void USART_Init(u16 baud);   //串口初始化
extern u8 USART_Rx(void);           //串口接收
extern void USART_Tx(u8 buf);       //串口发送
extern void USART_send(u8 a[]);     //发送字符串
extern void delay (int a);          //延时函数
#endif
